...
export function reducer(state = initialState, {type, payload}: any): StockState {
    if (!type) {
        return state;
    }
    switch (type) {
        ...
        case actions.ActionTypes.Do_STOCkLISTCOUNT: {
            console.log('list count', payload);
...
export const getStockStatusListLoading = (state: StockState) => state.listLoading;
...
export const getStockStatusCountLoading = (state: StockState) => state.countLoading;
export const getStockStatusCountLoaded = (state: StockState) => state.countLoaded;
export const getStockStatusCountFailed = (state: StockState) => state.countFailed;
...
export const getStockStatusUpdateLoading = (state: StockState) => state.updateLoading;
export const getStockStatusUpdateLoaded = (state: StockState) => state.updateLoaded;
export const getStockStatusUpdateFailed = (state: StockState) => state.updateFailed;

export const getStockStatusDeleteLoading = (state: StockState) => state.deleteLoading;
export const getStockStatusDeleteLoaded = (state: StockState) => state.deleteLoaded;
export const getStockStatusDeleteFailed = (state: StockState) => state.deleteFailed;
