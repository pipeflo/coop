...
export function reducer(state = initialState, {type, payload}: any): CountryState {
    if (!type) {
        return state;
    }
...
export const getCountryCountLoading = (state: CountryState) => state.countLoading;
...
export const getCountryUpdateLoading = (state: CountryState) => state.updateLoading;
export const getCountryUpdateLoaded = (state: CountryState) => state.updateLoaded;
export const getCountryUpdateFailed = (state: CountryState) => state.updateFailed;

export const getCountryDeleteLoading = (state: CountryState) => state.deleteLoading;
export const getCountryDeleteLoaded = (state: CountryState) => state.deleteLoaded;
export const getCountryDeleteFailed = (state: CountryState) => state.deleteFailed;
