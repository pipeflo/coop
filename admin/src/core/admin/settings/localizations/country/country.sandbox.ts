...
export class CountrySandbox {
    ...
    subscribe() {
        ...
        this.subscriptions.push(this.addCountry$.subscribe(data => {
        ...
        this.subscriptions.push(this.updateCountry$.subscribe(data => {
            if (data) {
                if (data.message) {
                    this.router.navigate(['/settings/countries']);
                }
        ...
        this.subscriptions.push(this.getcountries$.subscribe(data => {
