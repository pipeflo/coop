...
import {
    getAddUser, getAddUserData, UserAddFailed, UserAddLoaded, UserAddLoading, UserCountFailed, UserCountLoaded,
    UserCountLoading,
    UserGroupFailed,
    UserGroupLoaded,
    UserGroupLoading,
    UserListFailed,
    UserListLoaded,
    UserListLoading, UserUpdateFailed, UserUpdateLoaded, UserUpdateLoading
...
export class UserSandbox {
    ...
    public getUserGrouplist(value: any) {
        this.appState.dispatch(new userActions.DoUserGroupListAction(value));
    }
