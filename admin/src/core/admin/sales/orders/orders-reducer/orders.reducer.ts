...
import {SalesOrderState, SalesOrderStateRecord} from '../orders-reducer/orders.state';
...
export function reducer(state = initialState, {type, payload}: any): SalesOrderState {
    if (!type) {
        return state;
    }
...
export const getOrderlistCount = (state: SalesOrderState) => state.OrderlistCount;
export const getOrderCountFailed = (state: SalesOrderState) => state.OrderCountFailed;
export const getOrderCountLoaded = (state: SalesOrderState) => state.OrderCountLoaded;
export const getOrderCountLoading = (state: SalesOrderState) => state.OrderCountLoading;
export const getvieworderData = (state: SalesOrderState) => state.vieworderData;
export const getVieworderLoaded= (state: SalesOrderState) => state.ViewOrderLoaded;
export const getVieworderFailed = (state: SalesOrderState) => state.ViewOrderFailed;
export const getVieworderLoading = (state: SalesOrderState) => state.ViewOrderLoading;
