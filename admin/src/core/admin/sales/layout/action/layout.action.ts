...
export const ActionTypes = {
  ...
  GET_TOTAL_ORDER_COUNT_SUCCESS: type('[SalesLayout] Get Sales Total Order Count Success'),
  GET_TOTAL_ORDER_COUNT_FAIL: type('[SalesLayout] Get Sales Total Order Count Fail'),

  GET_TODAY_ORDER_COUNT: type('[SalesLayout] Get Today Order Count'),
  GET_TODAY_ORDER_COUNT_SUCCESS: type('[SalesLayout] Get Today Order Count Success'),
  ...
  GET_TOTAL_ORDER_AMOUNT_SUCCESS: type('[SalesLayout] Get Total Order Amount Success'),
  GET_TOTAL_ORDER_AMOUNT_FAIL: type('[SalesLayout] Get Total Order Amount Fail'),

  GET_TODAY_ORDER_AMOUNT: type('[SalesLayout] Get Today Order Amount'),
  GET_TODAY_ORDER_AMOUNT_SUCCESS: type('[SalesLayout] Get Today Order Amount Success'),
