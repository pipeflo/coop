...
export function reducer(state = initialState, {type, payload}: any): PageState {
  if (!type) {
    return state;
  }
...
export const getpagescountloading = (state: PageState) => state.pagesCountLoading;
...
export const getpagesupdateloading = (state: PageState) => state.pagesUpdateLoading;
export const getpagesupdateloaded = (state: PageState) => state.pagesUpdateLoaded;
export const getpagesupdatefailed = (state: PageState) => state.pagesUpdateFailed;
export const getpagesdeleteloading = (state: PageState) => state.pagesDeleteLoading;
export const getpagesdeleteloaded = (state: PageState) => state.pagesDeleteLoaded;
export const getpagesdeletefailed = (state: PageState) => state.pagesDeleteFailed;
