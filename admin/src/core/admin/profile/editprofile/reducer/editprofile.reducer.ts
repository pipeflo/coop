...
import {EditprofileState, EditprofileRecordState} from '../store/editprofile.state';
export const initialState:EditprofileState = new EditprofileRecordState() as EditprofileState;

export function reducer(state = initialState, {type, payload}: any):EditprofileState {
    if (!type) {
        return state;
    }
...
export const geteditprofileResponse = (state: EditprofileState) => state.editprofileResponse;
export  const geteditprofileRequestLoading = (state: EditprofileState) => state.editprofileRequestLoading;
export  const geteditprofileRequestLoaded = (state: EditprofileState) => state.editprofileRequestLoaded;
export  const geteditprofileRequestFailed = (state: EditprofileState) => state.editprofileRequestFailed;
