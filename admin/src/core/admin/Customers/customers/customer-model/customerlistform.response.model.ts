...
export class CustomerlistformResponseForm {
    ...
    constructor(customerlistresponseform: any) {
        console.log('customerlistresponseform', customerlistresponseform);
        ...
        this.customerGroupId = customerlistresponseform.customerGroupId || 0;
        ...
        this.safe = customerlistresponseform.safe || 0;
