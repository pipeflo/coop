...
export function reducer(state = initialState, { type, payload }: any): CustomerLayoutState {
...
export const getTotalCustomerCount = (state: CustomerLayoutState) => state.totalCustomerCount;
export const getTotalCustomerCountLoading = (state: CustomerLayoutState) => state.totalCustomerCountLoading;
export const getTotalCustomerCountLoaded = (state: CustomerLayoutState) => state.totalCustomerCountLoaded;
export const getTotalCustomerCountFailed = (state: CustomerLayoutState) => state.totalCustomerCountFailed;

export const getActiveCustomerCount = (state: CustomerLayoutState) => state.activeCustomerCount;
export const getActiveCustomerCountLoading = (state: CustomerLayoutState) => state.activeCustomerCountLoading;
export const getActiveCustomerCountLoaded = (state: CustomerLayoutState) => state.activeCustomerCountLoaded;
export const getActiveCustomerCountFailed = (state: CustomerLayoutState) => state.activeCustomerCountFailed;

export const getInActiveCustomerCount = (state: CustomerLayoutState) => state.inactiveCustomerCount;
export const getInActiveCustomerCountLoading = (state: CustomerLayoutState) => state.inactiveCustomerCountLoading;
export const getInActiveCustomerCountLoaded = (state: CustomerLayoutState) => state.inactiveCustomerCountLoaded;
export const getInActiveCustomerCountFailed = (state: CustomerLayoutState) => state.inactiveCustomerCountFailed;
