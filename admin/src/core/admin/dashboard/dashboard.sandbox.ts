...
export class DashboardSandbox {
  ...
  public getOrderListCount(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetDashboardOrderCountAction(new OrderModel(params)));
  }

  public getProductListCount(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetDashboardProductCountAction(new ProductModel(params)));
  }

  public getCustomerListCount(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetDashboardCustomerCountAction(new CustomerModel(params)));
  }

  public getTopSellingProductList(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetTopSellingProductsAction(params));
  }
  ...
  public getRecentVisitorList(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetRecentVisitorListAction(params));
  }

  public getRecentSellingProductList(params: any = {}) {
    this.appState.dispatch(new dashboardActions.GetRecentSellingProductAction(params));
  }
