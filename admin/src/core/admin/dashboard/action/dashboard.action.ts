...
export const ActionTypes = {
  ...
  GET_DASHBOARD_ORDER_COUNT_SUCCESS: type('[Dashboard] Get Dashboard Order Count Success'),
  GET_DASHBOARD_ORDER_COUNT_FAIL: type('[Dashboard] Get Dashboard Order Count Fail'),

  GET_DASHBOARD_PRODUCT_COUNT: type('[Dashboard] Get Dashboard Product Count'),
  GET_DASHBOARD_PRODUCT_COUNT_SUCCESS: type('[Dashboard] Get Dashboard Product Count Success'),
  GET_DASHBOARD_PRODUCT_COUNT_FAIL: type('[Dashboard] Get Dashboard Product Count Fail'),

  GET_DASHBOARD_CUSTOMER_COUNT: type('[Dashboard] Get Dashboard Customer Count'),
  GET_DASHBOARD_CUSTOMER_COUNT_SUCCESS: type('[Dashboard] Get Dashboard Customer Count Success'),
  GET_DASHBOARD_CUSTOMER_COUNT_FAIL: type('[Dashboard] Get Dashboard Customer Count Fail'),
