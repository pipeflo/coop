...
export const getOrderCountLoading = (state: DashboardState) => state.orderCountLoading;
export const getOrderCountLoaded = (state: DashboardState) => state.orderCountLoaded;
export const getOrderCountFailed = (state: DashboardState) => state.orderCountFailed;

/* Product Count Actions */
export const getProductCount = (state: DashboardState) => state.productCount;
export const getProductCountLoading = (state: DashboardState) => state.productCountLoading;
export const getProductCountLoaded = (state: DashboardState) => state.productCountLoaded;
export const getProductCountFailed = (state: DashboardState) => state.productCountFailed;

/* Customer Count Actions */
export const getCustomerCount = (state: DashboardState) => state.customerCount;
export const getCustomerCountLoading = (state: DashboardState) => state.customerCountLoading;
export const getCustomerCountLoaded = (state: DashboardState) => state.customerCountLoaded;
export const getCustomerCountFailed = (state: DashboardState) => state.customerCountFailed;

/* Top selling product list Actions */
export const getTopSellingProducts = (state: DashboardState) => state.topSellingProducts;
export const getTopSellingProductsLoading = (state: DashboardState) => state.topSellingProductsLoading;
export const getTopSellingProductsLoaded = (state: DashboardState) => state.topSellingProductsLoaded;
export const getTopSellingProductsFailed = (state: DashboardState) => state.topSellingProductsFailed;

/* sales order list Actions */
export const getSalesOrderList = (state: DashboardState) => state.salesOrderList;
export const getSalesOrderListLoading = (state: DashboardState) => state.salesOrderListLoading;
export const getSalesOrderListLoaded = (state: DashboardState) => state.salesOrderListLoaded;
export const getSalesOrderListFailed = (state: DashboardState) => state.salesOrderListFailed;

/* visitor log list Actions */
export const getVisitorLogs = (state: DashboardState) => state.visitorLogs;
export const getVisitorLogsLoading = (state: DashboardState) => state.visitorLogsLoading;
export const getVisitorLogsLoaded = (state: DashboardState) => state.visitorLogsLoaded;
export const getVisitorLogsFailed = (state: DashboardState) => state.visitorLogsFailed;

/* recent visitor list Actions */
export const getRecentVisitorList = (state: DashboardState) => state.recentVisitorList;
export const getRecentVisitorListLoading = (state: DashboardState) => state.recentVisitorListLoading;
export const getRecentVisitorListLoaded = (state: DashboardState) => state.recentVisitorListLoaded;
export const getRecentVisitorListFailed = (state: DashboardState) => state.recentVisitorListFailed;

/* recent selling produce list Actions */
export const getRecentSellingProduct = (state: DashboardState) => state.recentSellingProduct;
export const getRecentSellingProductLoading = (state: DashboardState) => state.recentSellingProductLoading;
export const getRecentSellingProductLoaded = (state: DashboardState) => state.recentSellingProductLoaded;
export const getRecentSellingProductFailed = (state: DashboardState) => state.recentSellingProductFailed;
