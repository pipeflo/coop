...
export function reducer(state = initialState, {type, payload}: any): Media {
    ...
    switch (type) {
        ...
        case actions.ActionTypes.DO_BUCKETLIST_FAIL: {
            console.log('BUCKET  LIST fail REDUCER', payload);
            return Object.assign({}, state, {
                // bucketlist: payload,
                bucketlistResponse: false,
                bucketlistRequestLoading: false,
...
export const getmediauploadResponse = (state: Media) => state.mediauploadResponse;
export const getmediauploadRequestLoading = (state: Media) => state.mediauploadRequestLoading;
export const getmediauploadRequestLoaded = (state: Media) => state.mediauploadRequestLoaded;
export const getmediauploadRequestFailed = (state: Media) => state.mediauploadRequestFailed;
// Media delete folder
export const getBucketdeletefolder = (state: Media) => state.bucketdeletefolder;
export const getdeletefolderResponse = (state: Media) => state.deletefolderResponse;
export const getdeletefolderRequestLoading = (state: Media) => state.deletefolderRequestLoading;
export const getdeletefolderRequestLoaded = (state: Media) => state.deletefolderRequestLoaded;
export const getdeletefolderRequestFailed = (state: Media) => state.deletefolderRequestFailed;
// Media bucklist
export const getbucketlistResponse = (state: Media) => state.bucketlistResponse;
export const getbucketlistRequestLoading = (state: Media) => state.bucketlistRequestLoading;
export const getbucketlistRequestLoaded = (state: Media) => state.bucketlistRequestLoaded;
export const getbucketlistRequestFailed = (state: Media) => state.bucketlistRequestFailed;
