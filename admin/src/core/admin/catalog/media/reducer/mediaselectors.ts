...
// Media upload
export const getMediaUploaddata = createSelector(getAddmediaState, fromMedia.getMediaUpload);
// Media delete file
export const getbucketDeleteFile = createSelector(getAddmediaState, fromMedia.getBucketdeletefile);
// Media upload
...
export const getmediauploadRequestFailed = createSelector(getAddmediaState, fromMedia.getmediauploadRequestFailed);
// Media delete folder
...
export const getdeletefolderRequestFailed = createSelector(getAddmediaState, fromMedia.getdeletefolderRequestFailed);
// Media bucket list
...
export const getbucketlistRequestFailed = createSelector(getAddmediaState, fromMedia.getbucketlistRequestFailed);
