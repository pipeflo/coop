...
// selectors
import {
    getbucketDeleteFile, getbucketDeleteFolder,
    getBucketListData, getMediaCreatefolder,
    getMediaUploaddata, getmediauploadResponse,
     getmediauploadRequestLoaded,
    getmediauploadRequestFailed, getbucketlistRequestFailed,
    getdeletefolderResponse, getdeletefolderRequestLoading,
    getdeletefolderRequestLoaded, getdeletefolderRequestFailed,
    getbucketlistResponse, getbucketlistRequestLoading,
...
export class MediaSandbox {
    ...
    public getdeletefolderResponse$ = this.appState.select(getdeletefolderResponse);
    public getdeletefolderRequestLoading$ = this.appState.select(getdeletefolderRequestLoading);
    public getdeletefolderRequestLoaded$ = this.appState.select(getdeletefolderRequestLoaded);
    public getdeletefolderRequestFailed$ = this.appState.select(getdeletefolderRequestFailed);

    public getbucketlistResponse$ = this.appState.select(getbucketlistResponse);
    public getbucketlistRequestLoading$ = this.appState.select(getbucketlistRequestLoading);
    public getbucketlistRequestLoaded$ = this.appState.select(getbucketlistRequestLoaded);
    public getbucketlistRequestFailed$ = this.appState.select(getbucketlistRequestFailed);
