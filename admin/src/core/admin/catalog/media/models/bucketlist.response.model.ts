...
export interface BucketContentModel {
    ...
    //
    //     this.Key = bucketResponse.Key || '';
    //     this.LastModified = bucketResponse.LastModified || '';
    //     this.ETag = bucketResponse.ETag || '';
    //     this.Size = bucketResponse.Size || '';
    //     this.StorageClass = bucketResponse.StorageClass || '';
    //     this.Owner = bucketResponse.Owner || {};
    //
    // }
