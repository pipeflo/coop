...
export const ActionTypes = {
  ...
  GET_TOTAL_PRODUCT_COUNT_SUCCESS: type('[CatalogLayout] Get Total Product Count Success'),
  GET_TOTAL_PRODUCT_COUNT_FAIL: type('[CatalogLayout] Get Total Product Count Fail'),

  GET_ACTIVE_PRODUCT_COUNT: type('[CatalogLayout] Get Active Product Count'),
  GET_ACTIVE_PRODUCT_COUNT_SUCCESS: type('[CatalogLayout] Get Active Product Count Success'),
  GET_ACTIVE_PRODUCT_COUNT_FAIL: type('[CatalogLayout] Get Active Product Count Fail'),

  GET_INACTIVE_PRODUCT_COUNT: type('[CatalogLayout] Get In Active Product Count'),
  GET_INACTIVE_PRODUCT_COUNT_SUCCESS: type('[CatalogLayout] Get In Active Product Count Success'),
  GET_INACTIVE_PRODUCT_COUNT_FAIL: type('[CatalogLayout] Get In Active Product Count Fail'),

  GET_TOTAL_CATAGORY_COUNT: type('[CatalogLayout] Get Total Catagory Count'),
  GET_TOTAL_CATAGORY_COUNT_SUCCESS: type('[CatalogLayout] Get Total Catagory Count Success'),
  GET_TOTAL_CATAGORY_COUNT_FAIL: type('[CatalogLayout] Get Total Catagory Count Fail'),

  GET_FEATURED_PRODUCT_COUNT: type('[CatalogLayout] Get Featured Product Count'),
  GET_FEATURED_PRODUCT_COUNT_SUCCESS: type('[CatalogLayout] Get Featured Product Count Success'),
  GET_FEATURED_PRODUCT_COUNT_FAIL: type('[CatalogLayout] Get Featured Product Count Fail'),
};
...
/* Featured Product Count Actions */

export class GetFeaturedProductCountAction implements Action {
  type = ActionTypes.GET_FEATURED_PRODUCT_COUNT;
...
export class GetFeaturedProductCountSuccessAction implements Action {
  type = ActionTypes.GET_FEATURED_PRODUCT_COUNT_SUCCESS;

  constructor(public payload: any) {
    console.log('action', this.payload);
  }
}
export class GetFeaturedProductCountFailAction implements Action {
  type = ActionTypes.GET_FEATURED_PRODUCT_COUNT_FAIL;
...
export type Actions
  ...
  | GetFeaturedProductCountAction
  | GetFeaturedProductCountSuccessAction
  | GetFeaturedProductCountFailAction;
