...
// url address
  ...
  setDelManufact(value: any, checked: any, checkLength: any)  {
    ...
    console.log('this', this.checkLength);
  }
  getDelManufact() {
    // console.log(this.delManufactvalue)
...
// passing manufacture editdata
  ...
  public manufacturerList(params: ManufacturerListModel): Observable<any> {
    console.log('manufacture api calling' , params );
    const reqOpts: any = {};
    if (params) {
    ...
    return this.http.get(this.url + '/manufacturer/manufacturerlist', reqOpts);
  }
    /**
  ...
  updateManufacturer(value: any) {
    console.log('update manufacturerform', value);
  ...
  addManufactureData(value: any) {
    console.log('manufacture Api', value);
    ...
    console.log('delete api', value);
    console.log('delete api', value.manufacturerId);
    const httpOptions = {
