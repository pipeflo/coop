...
export class CategoriesSandbox {
    ...
    public getUpdateCategoriesountdatas$ = this.appState.select(getCategoryCountdata);
    public getUpdateCategoriesBadresponse$ = this.appState.select(getUpdateCategoryBadresponse);

    public getDeleteCategoriesResponse$ = this.appState.select(getDeleteCategoriesResponse);
    public getDeleteCategoriesRequestLoading$ = this.appState.select(getDeleteCategoriesRequestLoading);
    public getDeleteCategoriesRequestLoaded$ = this.appState.select(getDeleteCategoriesRequestLoaded);
    public getDeleteCategoriesRequestFailed$ = this.appState.select(getDeleteCategoriesRequestFailed);

    public getCategoriesCountResponse$ = this.appState.select(getCategoriesCountResponse);
    public getCategoriesCountRequestLoading$ = this.appState.select(getCategoriesCountRequestLoading);
    public getCategoriesCountRequestLoaded$ = this.appState.select(getCategoriesCountRequestLoaded);
    public getCategoriesCountRequestFailed$ = this.appState.select(getCategoriesCountRequestFailed);

    public getCategoriesListResponse$ = this.appState.select(getCategoriesListResponse);
    public getCategoriesListRequestLoading$ = this.appState.select(getCategoriesListRequestLoading);
    public getCategoriesListRequestLoaded$ = this.appState.select(getCategoriesListRequestLoaded);
    public getCategoriesListRequestFailed$ = this.appState.select(getCategoriesListRequestFailed);

    public getUpdateCategoriesResponse$ = this.appState.select(getUpdateCategoriesResponse);
    public getUpdateCategoriesRequestLoading$ = this.appState.select(getUpdateCategoriesRequestLoading);
    public getUpdateCategoriesRequestLoaded$ = this.appState.select(getUpdateCategoriesRequestLoaded);
    public getUpdateCategoriesRequestFailed$ = this.appState.select(getUpdateCategoriesRequestFailed);

    public getAddCategoriesResponse$ = this.appState.select(getAddCategoriesResponse);
    public getAddCategoriesRequestLoading$ = this.appState.select(getAddCategoriesRequestLoading);
    public getAddCategoriesRequestLoaded$ = this.appState.select(getAddCategoriesRequestLoaded);
    public getAddCategoriesRequestFailed$ = this.appState.select(getAddCategoriesRequestFailed);

    public getProductAddResponse$ = this.appState.select(getProductAddResponse);
    public getProductAddRequestLoading$ = this.appState.select(getProductAddRequestLoading);
    public getProductAddRequestLoaded$ = this.appState.select(getProductAddRequestLoaded);
    public getProductAddRequestFailed$ = this.appState.select(getProductAddRequestFailed);


    public getProductRemoveResponse$ = this.appState.select(getProductRemoveResponse);
    public getProductRemoveRequestLoading$ = this.appState.select(getProductRemoveRequestLoading);
    public getProductRemoveRequestLoaded$ = this.appState.select(getProductRemoveRequestLoaded);
    public getProductRemoveRequestFailed$ = this.appState.select(getProductRemoveRequestFailed);


    constructor(protected appState: Store<store.AppState>, private toastr: ToastrManager, private router: Router) {
    ...
    public updatecategories(value) {
        ...
        console.log('value in sandbox', value);
