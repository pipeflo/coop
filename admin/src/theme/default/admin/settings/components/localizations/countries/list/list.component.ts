...
// VARIABLES
    ...
    constructor(private router: Router, public countrySandbox: CountrySandbox, public service: CountryService) {
    ...
    addNewCountry() {
        ...
        this.router.navigate(['/settings/countries/add']);
    }
    ...
    editCountry(list) {
        ...
        this.router.navigate(['/settings/countries/edit', list.countryId]);
    }
