...
export class ZoneListComponent implements OnInit {
    ...
    constructor(private router: Router, public zoneSandbox: ZoneSandbox,
    ...
    AddeNewZone() {
        ...
        this.router.navigate(['/settings/zone/add']);
    ...
    editzone(list) {
        ...
        this.router.navigate(['/settings/zone/edit', list.zoneId]);
    }
