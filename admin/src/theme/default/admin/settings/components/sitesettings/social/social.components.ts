...
export class SocialComponents implements OnInit {
    ...
    constructor(public socialsandbox: SocialSandbox, public fb: FormBuilder, private router: Router) {
    ...
    initForm() {
        ...
        this.socialForm = this.fb.group({
            Facebook: this.Facebook, Google: this.Google
    ...
    subscripe() {
        ...
        this.subscriptions.push(this.socialsandbox.getSocial$.subscribe(data => {

            if (data && data[0]) {
                console.log('datewa', data[0]);
