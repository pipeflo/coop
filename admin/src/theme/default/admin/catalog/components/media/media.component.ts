...
export class MediaComponent implements OnInit {
    ...
    // Back event
    private previousIsclicked: boolean = false;
    ...
    // clickfolder event
    private foldergotclicked: boolean = false;
    ...
    convertBase64(inputValue: any): void {
        ...
        myReader.onloadend = (e) => {
            ...
            // console.log(' this.postImageUrl', this.postImageUrl);
        ...
        this.sandbox.getBucketListData$.subscribe(reponse => {
            if (reponse) {
                ...
                if (this.onetime == true) {
                    let length = this.arrayOfImages.length - 1;
                    let pathOfFolder: any = {};
    ...
    Back() {
        ...
        if (this.trashclickedback == true) {
            ...
            let p = this.folderPathData.length - 1;
