...
export class PagesAddComponent {
    // Variables
...
// Form  Initialization
    initForm() {
        ...
        this.metaTitle = new FormControl('', [Validators.required]);
        this.metaKeyword = new FormControl('', [Validators.required]);
        this.metaContent = new FormControl('', [Validators.required]);
    ...
    onSubmit() {
        ...
        if ((this.pagesForm.value.pageTitle != '') && (this.pagesForm.value.pageContent != '')
            && (this.pagesForm.value.metaTitle != '')
            && (this.pagesForm.value.metaContent != '') && (this.pagesForm.value.metaKeyword != '')) {
            let params: any = {};
