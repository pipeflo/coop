...
export class BannerAddComponent {
    ...
    initForm() {
        this.bannerForm = this.fb.group({
            ...
            bannerContent: [null, [Validators.required]],
            bannerLink: [null, [Validators.required,]],
    ...
    editBannerData() {
        ...
        if (this.bannerInfo && this.bannerInfo[0]) {
            ...
            for (var i = 0; i < this.bannerInfo.length; i++) {
                ...
                this.bannerContent = this.bannerInfo[0].content;
                this.bannerLink = this.bannerInfo[0].link;
                this.position = this.bannerInfo[0].position;
                this.postImageUrl = this.imageUrl + '?width=160&height=150&path=' + `${this.bannerInfo[0].imagePath}` + '&name=' + `${this.bannerInfo[0].image}`;
